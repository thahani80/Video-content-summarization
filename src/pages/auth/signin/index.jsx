      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col">
            ...
            <Link to={"/login"} className="text-sm text-[#415B93]">
              Sign in
            </Link>
          </div>
        </div>
        <h3 className="text-5xl font-medium">Sign up</h3>
        <form onSubmit={handleSubmit} className="flex flex-col mt-12 gap-y-6">
